...
class PlaybackSettingsAdapter(private val context: Context, private val list : ArrayList<SettingsModel>) : RecyclerView.Adapter<PlaybackSettingsAdapter.ShowsHolder>() {
