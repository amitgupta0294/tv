...
class RemindersSettingsAdapter(private val context: Context, private val list : ArrayList<SettingsModel>) : RecyclerView.Adapter<RemindersSettingsAdapter.ShowsHolder>() {
