...
class TvOptionsSettingsAdapter(private val context: Context, private val list : ArrayList<SettingsModel>) : RecyclerView.Adapter<TvOptionsSettingsAdapter.ShowsHolder>() {
